...
inconsistencies in the data in the [cBioPortal][1] data repository.

[1]: https://github.com/cBioPortal/cBioPortal
...
building, please open an issue at our [GitHub repository][2] and we will do our
best to resolve the issues with the code base. Data issues can be opened at
the cBioPortal [data repository][1].
  
[2]: https://github.com/waldronlab/cBioPortalData/issues
