---
title: "cgds Migration"
author: "Karim Mezhoud & Marcel Ramos"
date: "`r format(Sys.time(), '%B %d, %Y')`"
vignette: >
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteIndexEntry{Migrating from cgds to cBioPortalData}
...
This vignette aims to help developers migrate from the now defunct `cgds`
CRAN package. Note that the `cgds` package code is shown for comparison but it
...
```{r}
genetab <- geneTable(cbio, pageSize = 10000)
logi <- genetab[["hugoGeneSymbol"]] %in% c("NF1", "TP53", "ABL1")
entrez <- unlist(genetab[logi, "entrezGeneId"])
