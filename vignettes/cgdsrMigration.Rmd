...
# Genetic Profiles or Molecular Profiles {.tabset .tabset-fade .tabset-pills}
...
# Profile Data for a set of genes {.tabset .tabset-fade .tabset-pills}
...
## `cBioPortalData` (Indentifying samples)
...
automatically figures out all the sample identifiers in the study. Note that
`getDataByGenes` allows both Hugo and Entrez identifiers, as well as
`genePanelId`.
