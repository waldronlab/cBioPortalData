...
our_gbm_CNA$gbm_tcga_pub_cna_rae[,c("entrezGeneId", "sampleId", "value")]
```

```{r}
our_gbm_CNA <-cBioPortalData(
    api = cbio,
    studyId = "gbm_tcga_pub",
    genes = c("NF1", "TP53", "ABL1"),
    by = "hugoGeneSymbol",
...
our_gbm_Met$gbm_tcga_pub_methylation_hm27[,c("entrezGeneId", "sampleId", "value")]
```


```{r}
our_gbm_Met <- cBioPortalData(
    api = cbio,
    studyId = "gbm_tcga_pub",
    genes = c("NF1", "TP53", "ABL1"),
    by = "hugoGeneSymbol",
...
```{r}
cgdsr::getProfileData.CGDS(x = cgds, 
                           genes = c("NF1", "TP53", "ABL1"),
